      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-32">
          <div className="mt-auto max-w-4xl text-center">
            <h1 className="text-black mb-6 text-6xl font-bold ">A better way to track your application.</h1>
            <p className="text-muted-foreground mb-10 text-xl">Capture, Organise, and manage your job search in one place</p>
